...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `23.0µs` | `133.4µs` |
| [Day 2](./src/bin/02.rs) | `493.9µs` | `540.6µs` |
| [Day 3](./src/bin/03.rs) | `1.1ms` | `8.0ms` |
| [Day 4](./src/bin/04.rs) | `1.2ms` | `1.3ms` |
| [Day 5](./src/bin/05.rs) | `44.7µs` | `-` |
| [Day 6](./src/bin/06.rs) | `595.0ns` | `600.0ns` |
| [Day 7](./src/bin/07.rs) | `591.3µs` | `602.7µs` |
