...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `20.2µs` | `133.6µs` |
| [Day 2](./src/bin/02.rs) | `492.0µs` | `541.6µs` |
| [Day 3](./src/bin/03.rs) | `1.1ms` | `8.1ms` |
| [Day 4](./src/bin/04.rs) | `1.2ms` | `1.3ms` |
| [Day 5](./src/bin/05.rs) | `47.1µs` | `-` |
| [Day 6](./src/bin/06.rs) | `701.0ns` | `652.0ns` |
| [Day 7](./src/bin/07.rs) | `594.9µs` | `608.2µs` |
| [Day 8](./src/bin/08.rs) | `3.0ms` | `590.0ms` |
